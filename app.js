// ✅ app.js — version complète avec affichage distance/durée corrigé
...
labelsLayer.on("tileload", e => { try { e.tile.style.filter = "contrast(180%) brightness(80%)"; } catch {} });
...
/* ========== ITINÉRAIRE + AFFICHAGE DISTANCE/DURÉE ========== */
async function calculerItineraire(destLat, destLng) {
  ...
  try {
    ...
    const dureeMin = (path.time / 60000).toFixed(1);
    const summary = document.getElementById("routeSummary");
    if (summary) {
      summary.innerHTML = `🚗 Distance : <b>${distanceKm} km</b> &nbsp;&nbsp;⏱️ Durée : <b>${dureeMin} min</b>`;
